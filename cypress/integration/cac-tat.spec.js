...
describe('Central de Atendimento ao Cliente TAT', function() {
    ...
    it('preenche os campos obrigatórios e envia o formulário', function() {
        ...
        cy.tick(THREE_SECONDS_IN_MS); // adianta o relógio do navegador em 3s
    ...
    Cypress._.times(3, () => {  //Execute 3 vezes o mesmo teste
    ...
    it('preenche a area de texto usando o comando invoke', () => {
        const longText = Cypress._.repeat('0123456789', 25);
        cy.get('#open-text-area')
            .invoke('val', longText)
            .should('have.value', longText);
    });

    // Teste de API de uma requisição GET/HTTP
    it('faz uma requisição HTTP', () => {
        cy.request({
            ...
            const {status, statusText, body} = response; // desestruturando o response
